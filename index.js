...
var  rollSound = new Audio("Audio/Paper.mp3");
$('#paper').click(e => rollSound.play());

var  rollSound2 = new Audio("Audio/Rock.mp3");
$('#rock').click(e => rollSound2.play());

var  rollSound3 = new Audio("Audio/scissors.mp3");
$('#scissors').click(e => rollSound3.play());
